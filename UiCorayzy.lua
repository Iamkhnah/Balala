...
for a, a in pairs(b) do
    local b;
    b = hookfunction(a, function(...)
        local a = {...}
        for b, d in pairs(a) do
            for c, c in pairs(c) do
                if string.find(string.lower(tostring(b)), string.lower(tostring(c))) or
                    string.find(string.lower(tostring(d)), string.lower(tostring(c))) then
...
local function d(a, d)
    ...
    local function i(a)
        ...
        local a = c:Create(d, TweenInfo.new(0.15), {
            Position = a
        })
        a:Play()
    end
...
e.Image = "rbxassetid://16709074265"
e.Visible = false;
local a = Instance.new("UICorner")
a.Name = "MCNR"
a.Parent = e;
...
function a:Window(f, f, f)
    ...
    j.Image = "rbxassetid://16709074265"
    ...
    function d:Tab(d, f)
        ...
        if h == false then
            for a, a in ipairs(d) do
                c:Create(a, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
        ...
        function a:Notification(a)
            ...
            b.TextSize = 13.000;
            c:Create(b, TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                BackgroundTransparency = 1
            }):Play()
            wait(0.4)
            ...
            e.MouseEnter:Connect(function()
                c:Create(e, TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                    BackgroundColor3 = Color3.fromRGB(34, 34, 34)
                }):Play()
            end)
            e.MouseLeave:Connect(function()
                c:Create(e, TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
        ...
        function a:Button(a, b)
            ...
            g.MouseEnter:Connect(function()
                c:Create(i, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
            ...
            g.MouseButton1Click:Connect(function()
                g.TextSize = 0;
                c:Create(g, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                    TextSize = 15
                }):Play()
                b()
            end)
        ...
        function a:Toggle(a, b, d)
            ...
            o.Image = "rbxassetid://16709074265"
            j.Parent = h;
            ...
            k.MouseButton1Click:Connect(function()
                if e == false then
                    ...
                    c:Create(m, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
        ...
        function a:Dropdown(a, b, d)
            ...
            f.Image = "rbxassetid://16709074265"
            k.Name = "DropTitle"
            k.Parent = g;
            ...
            for a, a in next, b do
                ...
                b.MouseEnter:Connect(function()
                    c:Create(b, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                        TextTransparency = 0
                    }):Play()
                end)
                ...
                b.MouseButton1Click:Connect(function()
                    ...
                    c:Create(p, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                        Rotation = 180
                    }):Play()
                    d(b.Text)
                    o.Text = b.Text
            ...
            function b:Add(b)
                ...
                f.MouseEnter:Connect(function()
                    c:Create(f, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                        TextTransparency = 0
                    }):Play()
                end)
        ...
        function a:Slider(a, c, d, e, g)
            ...
            l.Image = "rbxassetid://16709074265"
            m.Parent = j;
            ...
            o.InputBegan:Connect(function(b)
                if b.UserInputType == Enum.UserInputType.MouseButton1 or b.UserInputType == Enum.UserInputType.Touch then
                    ...
                    game.TweenService:Create(t,
                        TweenInfo.new(0.08, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                            TextTransparency = 0
                        }):Play()
                    game.TweenService:Create(n,
                        TweenInfo.new(0.08, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                            BackgroundTransparency = 0.5
                        }):Play()
                    game.TweenService:Create(u,
                        TweenInfo.new(0.08, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                            Transparency = 0
                        }):Play()
                end
                ...
                if a == "Text" then
                    if tonumber(t.Text) then
                        if tonumber(t.Text) <= d then
                            Value = t.Text;
                            v.Text = t.Text;
                            p:TweenPosition(UDim2.new(((tonumber(t.Text) or c) - c) / (d - c), 0, 0, 0), "InOut",
                                "Linear", 0.08, true)
                            v:TweenPosition(UDim2.new(((tonumber(t.Text) or c) - c) / (d - c), 0, 0, 0), "InOut",
                                "Linear", 0.12, true)
                            pcall(function()
                                g(Value)
                            end)
        ...
        function a:Slider2(a, b, c, d, e)
            ...
            k.Image = "rbxassetid://16709074265"
            l.Parent = i;
        ...
        function a:Seperator(a)
            ...
            g.Color = ColorSequence.new {ColorSequenceKeypoint.new(0.00, _G.Dark),
                                         ColorSequenceKeypoint.new(0.50, _G.Primary),
                                         ColorSequenceKeypoint.new(1.00, _G.Dark)}
            g.Parent = c;
            h.Color = ColorSequence.new {ColorSequenceKeypoint.new(0.00, _G.Dark),
                                         ColorSequenceKeypoint.new(0.50, _G.Primary),
                                         ColorSequenceKeypoint.new(1.00, _G.Dark)}
            h.Parent = e
        end
        function a:Line()
            ...
            c.Color = ColorSequence.new {ColorSequenceKeypoint.new(0.00, _G.Dark),
